...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libwebp_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c5f90fcd-3b7e-5836-afba-fc50a0988cb2"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libwebp", artifacts_toml) for e in artifacts["libwebp"]]
...
if best_platform === nothing
    @debug("Unable to load libwebp; unsupported platform $(triplet(platform_key_abi()))")
else
