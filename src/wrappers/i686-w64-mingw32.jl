...
export webpmux, libwebpmux, cwebp, gif2webp, img2webp, libwebp, libwebpmux, webpinfo, libwebpdemux, libwebpdecoder, dwebp
...
const webpmux_splitpath = ["bin", "webpmux.exe"]
...
const libwebpmux_splitpath = ["bin", "libwebpmux-3.dll"]
...
const libwebpmux = "libwebpmux-3.dll"


# Relative path to `cwebp`
const cwebp_splitpath = ["bin", "cwebp.exe"]
...
const gif2webp_splitpath = ["bin", "gif2webp.exe"]
...
const img2webp_splitpath = ["bin", "img2webp.exe"]
...
const libwebp_splitpath = ["bin", "libwebp-7.dll"]
...
const webpinfo_splitpath = ["bin", "webpinfo.exe"]
...
const libwebpdemux_splitpath = ["bin", "libwebpdemux-2.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libwebpdemux = "libwebpdemux-2.dll"


# Relative path to `libwebpdecoder`
const libwebpdecoder_splitpath = ["bin", "libwebpdecoder-3.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libwebpdecoder = "libwebpdecoder-3.dll"


# Relative path to `dwebp`
const dwebp_splitpath = ["bin", "dwebp.exe"]
